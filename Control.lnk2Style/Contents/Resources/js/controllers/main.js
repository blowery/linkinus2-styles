...
function updateWidths() {
	...
	$('div.post.normal span.message,').width(windowWidth-130);
...
function appendMessage(messageDetails) {
	...
	switch(messageDetails[MESSAGE_TYPE_KEY]) {
	    case 'msgMessage':
	        $message = '<div id="'+ id +'" class="post normal '+extraclass+'"><span class="nickname" title="'+lngNick+'">'+strTime+shtNick+'</span><span class="message" style="width:'+parseInt(windowWidth-130)+'px"><span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
	    case 'msgAction':
    	    $message = '<div id="'+ id +'" class="post action '+extraclass+'"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> <span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgRaw':
    	    ...
    	    break;
	    case 'msgJoin':
    	    $message = '<div id="'+ id +'" class="post join '+extraclass+'"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has joined the room <span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgPart':
    		if(desc.length > 0){desc = '('+desc+')';}
    	    $message = '<div id="'+ id +'" class="post part '+extraclass+'"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has parted the room '+desc+'</span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgQuit':
    		if(desc.length > 0){desc = '('+desc+')';}
    	    $message = '<div id="'+ id +'" class="post quit '+extraclass+'"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has quit '+desc+'</span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgKick':      	   	
    		if(desc.length > 0){desc = '('+desc+')';}
    	    $message = '<div id="'+ id +'" class="post kick '+extraclass+'"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has kicked ' + messageDetails[EXTRA_DATA_KEY] + ' from the room '+desc+'</span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgModeChange':
    	    $message = '<div id="'+ id +'" class="post mode-change '+extraclass+'"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has changed the mode to <span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgNick':
    	    $message = '<div id="'+ id +'" class="post nick '+extraclass+'"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has changed their nick to "<span class="description">'+desc+'</span>"</span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgTopicChange':
    	    $message = '<div id="'+ id +'" class="post topic-change '+extraclass+'"><span class="message"><span class="description" style="display:block;width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has changed the topic to "'+desc+'"</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgTopicDetailsReply':
    	    $message = '<div id="'+ id +'" class="post topic-details-reply '+extraclass+'"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="description">Set by <span class="nickname">'+lngNick+'</span> on '+messageDetails[EXTRA_DATA_KEY] +'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgNotice':
    	case 'msgNoticeAuth':
    	    $message = '<div id="'+ id +'" class="post notice '+extraclass+'"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="description">'+desc+'</span></span>';
    	    break;
	}	
