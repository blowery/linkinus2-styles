...
function appendMessage(messageDetails) {
	...
	lngNick = '<span class="nick">'+lngNick+'</span>';
	...
	switch(messageDetails[MESSAGE_TYPE_KEY]) {
	    case 'msgMessage':
	        $message = '<div id="'+ id +'" class="post '+extraclass+'"><span class="nickname">'+strTime+lngNick+'</span><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
	    case 'msgAction':
    	    $message = '<div id="'+ id +'" class="post action"><span class="message '+extraclass+'" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> <span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgRaw':
    	    $message = '<div id="'+ id +'" class="post raw '+extraclass+'"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
	    case 'msgJoin':
    	    $message = '<div id="'+ id +'" class="post join"><span class="message '+extraclass+'" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has joined the room <span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgPart':
    		if(desc.length > 0){desc = '('+desc+')';}
    	    $message = '<div id="'+ id +'" class="post part"><span class="message '+extraclass+'" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has parted the room <span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgQuit':
    		if(desc.length > 0){desc = '('+desc+')';}
    	    $message = '<div id="'+ id +'" class="post quit"><span class="message '+extraclass+'" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has quit <span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgKick':    	 
    		if(desc.length > 0){desc = '('+desc+')';}
    	    $message = '<div id="'+ id +'" class="post kick"><span class="message '+extraclass+'" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has kicked ' + messageDetails[EXTRA_DATA_KEY] + '<span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgModeChange':
    	    $message = '<div id="'+ id +'" class="post mode-change"><span class="message '+extraclass+'" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has changed the mode to <span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgNick':
    	    $message = '<div id="'+ id +'" class="post nick"><span class="message '+extraclass+'" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has changed their nick to "<span class="description">'+desc+'</span>"</span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgTopicChange':
    	    $message = '<div id="'+ id +'" class="post topic-change"><span class="message '+extraclass+'" style="width:'+parseInt(windowWidth-30)+'px"><span class="nickname">'+lngNick+'</span> has changed the topic to "<span class="description">'+desc+'</span>"</span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgTopicDetailsReply':
    	    $message = '<div id="'+ id +'" class="post topic-details-reply"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="description">Set by <span class="nickname">'+lngNick+'</span> on '+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
    	case 'msgNotice':
    	case 'msgNoticeAuth':
    	    $message = '<div id="'+ id +'" class="post notice"><span class="message" style="width:'+parseInt(windowWidth-30)+'px"><span class="description">'+desc+'</span></span><span class="star" onClick="starPost($(this))" title="'+messageDetails[TIMESTAMP_KEY]+'"/>';
    	    break;
	}
	...
	if($('div.post-bubble:last').children('div.post:last').children('span.nickname').text() == lngNick) {	
		$('div.post-bubble:last').addClass('multi');
		$('div.post-bubble:last').append($message);
	} else {
		if(messageDetails[MESSAGE_TYPE_KEY] == 'msgMessage') {
			$('#inner').append('<div class="post-bubble normal">' + $message + '</div>');
		} else {
			$('#inner').append('<div class="post-bubble">' + $message + '</div>');		
		}
	}
	$('div.post:last span.nickname').width($('div.post:last span.nickname').width());
